...
/**
 * This class is used to test the various types of Power Ups. It is used to test the 1st level
 * variant.
 */
...
class PowerUpTest extends DukeApplicationTest {
  ...
  public void testPowerUpCreation() {
    ...
    assertEquals(Brick.BRICK_HEIGHT * 7 + Brick.BRICK_HEIGHT / 4.0 + 80 * BreakoutGame.SECOND_DELAY,
        myPowerUp0.getY());
  }
