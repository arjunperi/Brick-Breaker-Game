...
/**
 * This testing class has tests for the various kinds of bricks. It is used to test the 2nd level
 * variant.
 */
class BrickTest extends DukeApplicationTest {
  ...
  public void testBrickDestruction() {
    ...
    myDisplay.stats();
    assertEquals("Lives: 3 Score: 1 Level: " + myDisplay.getLevel() + " High Score: " + myDisplay
            .getHighScore(),
        myDisplay.getText());
  }
  ...
  public void testBrokenBrickDestructionAndNoCollision() {
    ...
    javafxRun(() -> myBreakoutGame.step(BreakoutGame.SECOND_DELAY));
    myDisplay.stats();
    assertEquals("Lives: 3 Score: 2 Level: " + myDisplay.getLevel() + " High Score: " + myDisplay
            .getHighScore(),
        myDisplay.getText());
